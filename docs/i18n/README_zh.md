...
<div align="center">
  <picture>
    ...
    <img src="../../assets/demo-zh-light.png" alt="一次真实调查，画成穿过三层的下潜。第一层「搜得到」：普通搜索引到规则，就撞上车挡停住。第二层「搜不到，因为要登录、埋得太深」：登录墙内的第一手时间线，以及埋在评论区的解法。第三层「搜不到，因为压根就不是文字」：中文讲解视频经本地转写，以及事实只在画面上的视频笔记。求索在每一层找到位置不同的开口，最后抵达答案。">
  </picture>
</div>
...
- **搜不到，因为要登录、埋得太深。** 一亩三分地上三份第一手时间线，在你自己的登录态背后：**曼谷**，预约到拿护照 25 天，面签到通过 30 分钟；**米兰**，抢号一个月，签出 5 年；**东京**，*「丝滑」*。米兰帖下，楼主回到评论区补充：*「先约一个靠后的日期，再发邮件给领事馆申请加急。有一位 F-1 申请人真的成功了。」* 个人经验，非官方指引。
- **搜不到，因为压根就不是文字。** bilibili 上一段中文解读视频，本地转写：头条说的*「最多待 4 年」*其实是初始停留期，延期只是换了审批部门，并没有消失。小红书一条视频笔记，正文只有四个话题标签，帧与语音本地读取：第三国遇上 212(a)(6)(C) 拒签（虚假陈述认定），F-1 之路几乎断送。
