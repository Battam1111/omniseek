...
- [ ] If walled / circumvention: it is marked `explicit_only` (and `needs_credentials` if it needs a logged-in session), kept out of the default pack, with its legal posture noted (SECURITY.md).
