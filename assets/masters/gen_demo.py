...
LANGS = {
    "en": {
        ...
        "@@SURFDIV@@": "plain search &middot; where it stops",
        ...
        "@@DIVIDER@@": "OmniSeek &middot; the seek continues",
        ...
        "@@VERDICT@@": "Search quoted the rule and stopped. The people who had lived it held <b>the timelines, the workaround, and the risk</b>. OmniSeek kept seeking and brought back all of it, each line attributed.",
    ...
    "zh": {
        ...
        "@@VERDICT@@": "搜索引到规则就停了。真正办过的人手里有<b>时间线、解法和风险</b>。OmniSeek 一路求索，把它们全部带回，每一行都有出处。",
    ...
    "ja": {
        ...
        "@@VERDICT@@": "検索は規則を引用して止まった。実際に経験した人々は<b>タイムラインと回避策とリスク</b>を持っていた。OmniSeek は探し続け、そのすべてを出典つきで持ち帰った。",
