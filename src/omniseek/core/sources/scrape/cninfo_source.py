...
PDF on static.cninfo.com.cn → pair with omniseek_read for full-text filing analysis. Telos
...
def _ann_to_doc(a: dict) -> Optional[Document]:
    ...
    return Document(
        ...
        url=_PDF_BASE + adj,  # the filing PDF — omniseek_read it for the full body
        title=title,
