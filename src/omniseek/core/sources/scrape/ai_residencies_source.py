...
The 时间敏感 piece of OmniSeek: residency application windows are rigid, and
...
TIMEOUT = 20
USER_AGENT = "omniseek/0.1 (automated retrieval / residency tracking)"
...
class ResidencyPosition:
    ...
    def to_omniseek_doc(self) -> Document:
        tags = [
            "residency",
