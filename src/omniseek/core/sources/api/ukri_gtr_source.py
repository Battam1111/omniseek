...
grant category, research subjects/topics, participating organisations + award amounts. OmniSeek's
...
class UKRIGtRAdapter(BaseScrapeAdapter):
    ...
    description = (
        ...
        "博士赴英找实验室/资助方向/机构的一手结构 (网搜给不出). Keyless JSON API. STRUCTURE, 命名钻取 (omniseek_search 单源 raw)."
    )
