...
# Runtime state lives under ~/.omniseek/state/curator/ (same tree as candidates.json + the
...
# stops and runs a FINAL FLUSH of the un-persisted counter window (see omniseek.core.lifecycle).
