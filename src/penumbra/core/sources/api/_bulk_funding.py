"""Shared helpers for Penumbra's bulk-file FUNDING sources (the NSERC pattern, reused by SSHRC/CIHR).
...
This module name starts with '_' and does NOT end in '_source', so the penumbra.server walk skips it;
