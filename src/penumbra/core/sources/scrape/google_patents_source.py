...
for the outer ``url=...``). A real browser User-Agent is required (the PenumbraEye UA is
...
# patents.google.com 403s the default PenumbraEye UA; the XHR endpoint wants a real browser UA.
BROWSER_UA = (
