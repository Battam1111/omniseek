...
Google does NOT index at all — mp.weixin.qq.com is closed to general crawlers. Penumbra's
...
penumbra_add_url later (Penumbra's web fetch reads mp.weixin articles).
