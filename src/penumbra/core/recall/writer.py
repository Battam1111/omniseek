...
from penumbra.core.recall.journal import JournalCorrupt, JournaledObservation, ObservationJournal, ObservationReceipt
...
# tail. See penumbra.core.lifecycle. _STOP_POLL_S bounds the idle queue-get so a stop is noticed within
