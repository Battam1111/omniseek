...
penumbra_transcribe gives the eye a video's spoken WORDS; this gives it the PICTURE -- the slides,
...
def video_frames(url: str, start=None, duration=None, n: int = _DEFAULT_N,
    ...
    from penumbra.core import _optdep
    imageio_ffmpeg = _optdep.require("imageio_ffmpeg", "asr")

    from penumbra.core.asr import _parse_ts
