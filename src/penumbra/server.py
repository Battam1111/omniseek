...
_PENUMBRA_INSTRUCTIONS = (
    ...
    "cache_only=True pickup; max 3 penumbra_search_ranked per gather, and keep their combined "
    "limits to ~10-12 docs: results carry FULL documents, so two limit-6 searches already "
    "return ~70KB). "
